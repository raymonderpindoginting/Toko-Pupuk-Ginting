...
<div class="container mt-4">
    <div class="card shadow rounded-4 p-4" style="border-top:4px solid #28a745;">
        <h4 class="mb-4 text-success fw-bold">Edit Produk</h4>
        ...
        <form action="/produk/{{ $produk->id }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_produk"
                       ...
                       class="form-control border-success" placeholder="Masukkan nama produk" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="harga"
                       value="{{ $produk->harga }}"
                       class="form-control border-success" placeholder="Masukkan harga" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="stok"
                       value="{{ $produk->stok }}"
                       class="form-control border-success" placeholder="Masukkan stok" required>
            </div>
